...
% switch j,
%   case 1,  b = (1./6).*(2+xi).*(2+xi).*(2+xi);  % MATLAB! b = (2+xi).^3;
%   case 2,  b = -(1./6).*(3*xi+6).*xi.^2+4;      % -xi.^3 - 2*(xi+1).^3 +6*(xi+1);
%   case 3,  b =  (1./6).*(3*xi-6).*xi.^2+4;      % xi.^3 + 2*(xi-1).^3 -6*(xi-1);
%   case 4,  b = (1./6).*(2-xi).*(2-xi).*(2-xi);  % MATLAB! b = (2-xi).^3;
%   case 5,  b =  (1./6).*3*(2+xi).^2;
%   case 6,  b = -(1./6).*(9*xi+12).*xi;          % -3*xi.^2 - 6*(xi+1).^2+6;
%   case 7,  b =  (1./6).*(9*xi-12).*xi;          %  3*xi.^2 + 6*(xi-1).^2-6;
%   case 8,  b = -(1./6).*3*(2-xi).^2;
% end;
